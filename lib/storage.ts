...
export async function saveProject(
  ...
  try {
    ...
    const sanitizedStamps = stamps.map((s, idx) => ({
      ...
      textObjectsFrames: s.textObjectsFrames ?? undefined,
      imageLayersFrames: s.imageLayersFrames ?? undefined,
      drawingStrokesFrames: s.drawingStrokesFrames ?? undefined,
    }));
    ...
    const sanitizeConfig = (config: ExportConfig | null): ExportConfig | null => {
      ...
      return {
        ...
        textObjectsFrames: config.textObjectsFrames ?? undefined,
        imageLayersFrames: config.imageLayersFrames ?? undefined,
        drawingStrokesFrames: config.drawingStrokesFrames ?? undefined,
      };
    };
